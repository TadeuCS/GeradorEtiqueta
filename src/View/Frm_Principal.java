            ...
            public void run() {
                ...
                try {
                    ...
                    if (tipo == 0) {
                        ...
                        if (geraRelatorios.imprimirByLista("Etiqueta 10x3.5.jasper", parameters, etiquetas) == false) {
                            if (geraRelatorios.imprimirByLista("src/Relatorios/Etiqueta 10x3.5.jasper", parameters, etiquetas) == true);
                        }
                    } else {
